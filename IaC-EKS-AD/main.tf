...
# Create pub subnets
resource "aws_subnet" "sub-pub-asg-a" {
...
resource "aws_subnet" "sub-pub-asg-b" {
  vpc_id                  = var.default_VPC_id
...
resource "aws_iam_role" "eks-iam-role" {
  name = "iamrole-myekstest-cluster"
...
resource "aws_eks_cluster" "myekstest-eks" {
  ...
  vpc_config {
    subnet_ids = [aws_subnet.sub-pub-asg-a.id, aws_subnet.sub-pub-asg-b.id]
  }
